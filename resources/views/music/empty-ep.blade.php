...
<div class="h-auto lg:h-full col-span-4 flex">
    <div class="bg-colorPrimary/60 text-sm lg:text-2xl flex flex-col lg:flex-row justify-center items-start text-white p-8 lg:p-20 py-20 text-left lg:text-justify">
        ...
        <div class="lg:w-1/2">
            <h1 class="mb-4 lg:mb-6 px-4 lg:px-0 text-4xl font-bold font-lexend">EP Name</h1>
            <p class="text-base lg:text-lg mb-6 px-4 lg:px-0">
                Release Date: [Insert Date]
            </p>
            <p class="text-base lg:text-lg mb-6 px-4 lg:px-0">
                [Short description of the EP and its themes. What inspired it? How does it reflect your journey? Make sure that the text is long enough to fill the space, but not too long that it becomes overwhelming.]
            </p>
        </div>
